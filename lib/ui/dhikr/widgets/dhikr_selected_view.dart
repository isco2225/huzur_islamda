...
class DhikrSelectedView extends StatelessWidget {
  const DhikrSelectedView({
    super.key,
        ...
        children: [
          ...
          Expanded(
            child: ValueListenableBuilder(
              valueListenable: fetchDhikrsViewModel.isInitialLoading,
              builder: (context, isInitialLoading, _) {
                if (isInitialLoading) {
                  return const Center(child: CircularProgressIndicator());
                }
                return ValueListenableBuilder(
                  valueListenable: fetchDhikrsViewModel.groupDhikrs,
                            ...
                            child: TabBarView(
                              children: [
                                InfinityScrollableDhikrs(
                                  ...
                                  dhikrs: fetchDhikrsViewModel.dhikrs,
                                  hasError:
                                      fetchDhikrsViewModel.fetchDhikrs.error,
                                  isFetching:
                                      fetchDhikrsViewModel.fetchDhikrs.running,
                                  isAllItemsFetched: fetchDhikrsViewModel
                                      .fetchDhikrs
                                      .completed,
                                ),
